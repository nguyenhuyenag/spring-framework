...
/*_
 	Vòng đời của thread:
	  ...
	  - WAITING: Là trạng thái khi thread phải đợi thread nào đó hoàn thành, với một
	    khoảng thời gian không xác định trước. Trạng thái này khác với BLOCKED. Ở
	    trên kia là các thread bị hệ thống khoá lại khi cùng truy xuất chung đến một
	    tài nguyên hệ thống. Còn trạng thái này là giữa các Thread tự điều đình với nhau.
