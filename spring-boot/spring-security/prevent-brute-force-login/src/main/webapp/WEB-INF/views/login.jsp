...
<body>
	<sec:authorize access="isAuthenticated()">
		<div class="alert alert-secondary text-center mt-3">
			<p>
				You are already logged in. Please click <a href="./">here</a> to
	...
	<sec:authorize access="!isAuthenticated()">
		<div class="container mt-5 d-flex justify-content-center align-items-center">
			<div class="d-flex flex-column justify-content-center align-items-center border w-50 py-5 shadow-lg rounded">
				...
				<form id='loginForm' class="w-75" onsubmit="onSubmit(event); return false;">
					...
					<div class="form-group">
						<div class="input-group">
							<input type="password" class="form-control" name="password"
								id="inputPassword" placeholder="Mật khẩu" value="" required />
							<div class="input-group-append">
								<span id="toggle-eye" class="input-group-text make-pointer">
									<!--Font awesome icon--> <i class="fa fa-eye d-none"
									id="show_eye"></i> <i class="fa fa-eye-slash" id="hide_eye"></i>
								</span>
							</div>
						</div>
					</div>
<!-- 					<div class="form-group">
					...
					<sec:csrfInput />
					<button id='submitButton' type="submit" class="btn btn-primary w-100 mt-3">Đăng Nhập</button>
				</form>
			</div>
		</div>
