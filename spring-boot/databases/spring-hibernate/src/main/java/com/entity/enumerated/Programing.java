...
public class Programing {
	...
	@Enumerated(EnumType.STRING) 	 // Chuyển enum sang string để lưu xuống database
	// @Enumerated(EnumType.ORDINAL) // Chuyển enum sang số 0, 1, 2,.. tương ứng với ố thứ tự trong enum để lưu xuống db
