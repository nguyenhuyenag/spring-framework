...
public class UserService {
	...
	public String signin(String username, String password) {
		try {
			...
			return jwtProvider.buildToken(username, userRepository.findByUsername(username).getListRoles());
	...
	public String signup(User user) {
		if (!userRepository.existsByUsername(user.getUsername())) {
			...
			return jwtProvider.buildToken(user.getUsername(), user.getListRoles());
		} else {
